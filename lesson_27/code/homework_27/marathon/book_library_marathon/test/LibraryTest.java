package homework_27.marathon.book_library_marathon.test;
...
class LibraryTest {
    ...
    @Test
    void findBookTestByAuthorTest(){
        Book foundBook = library.findBookByAuthor("Orwell");
        assertEquals( books[0], library.findBookByAuthor("Orwell")); // find existed book
        assertNull(library.findBookByAuthor("Karamzin")); // find absent book
        //
    }
