...
//        assertEquals( books[0], library.findBook(1_111_111_111_110L)); // find existing book
...
//        assertEquals(3, library.size()); // проверяем ожидание в 3 книги, чтобы сошлись с size от объекта library
//        //remove absent book
